<template>
  ...
  <div class="flex items-center justify-between">
    <h1 class="text-white text-3xl font-bold text-center my-[14px]">用户信息表</h1>
    <!-- 添加用户按钮 -->
  ...
  <div class="overflow-y-auto !max-h-[655px]">
    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
      <thead class="text-sm sticky top-0 z-10 text-gray-700 bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
        <tr>
          <th scope="col" class="py-3 px-6">名称</th>
          <th scope="col" class="py-3 px-6">邮件</th>
          <th scope="col" class="py-3 px-6">身份</th>
